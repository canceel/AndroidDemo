package com.shenme.androiddemo.activity.location.method;
...
public class LocationHelper implements TencentLocationListener {
    ...
    public static TencentLocation mLastLocation;
    ...
    public void start(Runnable r) {
        if (!mStarted) {
            ...
            TencentLocationRequest request = TencentLocationRequest.create()
                    .setInterval(5000).setRequestLevel(TencentLocationRequest.REQUEST_LEVEL_NAME).setAllowCache(true);
